...
const redemptionOptions = [
  {
    ...
    icon: <Image className="w-[65px] h-[65px] mr-2" source={passport} /> // We'll replace this with proper icon component later
  },
  {
    id: '2',
    title: 'Fly and Claim',
    ...
    icon: <Image className="w-[65px] h-[65px] mr-2" source={plane} /> // We'll replace this with proper icon component later
  },
  {
    id: '3',
    ...
    icon: <Image className="w-[65px] h-[65px] mr-2" source={gift} /> // We'll replace this with proper icon component later
  }
];

export function Page3() {
  const renderItem = ({ item }) => (
    <View className="bg-[#1F1147] rounded-xl p-4 mb-4 flex-row items-center">
      {item.icon}
  ...
  return (
    <View className="flex-1 bg-[#130739]">
      ...
      <View className="mb-6 flex-row justify-between items-center px-6">
        ...
        <Button
          className="w-[40%]"
          onPress={() => openBrowserAsync('https://heymax.ai')}
        >
          Get Started
        </Button>
      </View>
